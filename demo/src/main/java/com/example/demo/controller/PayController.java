...
public class PayController {
	...
	@RequestMapping(value = "/savePoint.dox", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String savePoint(Model model, @RequestParam HashMap<String, Object> map) throws Exception {
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
		
		resultMap = payService.savePoint(map);
		return new Gson().toJson(resultMap);
	}
